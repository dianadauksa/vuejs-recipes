<template>
    <div class="p-8 pb-0">
        <h1 class="text-4xl font-bold mb-4 text-orange-500">Search By Ingredients</h1>
    </div>
    <div class="px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            <a href="#" @click.prevent="openIngredient(ingredient)" v-for="ingredient of computedIngredients"
                :key="ingredient.idIngredient" class="block bg-white rounded p-3 mb-3 shadow hover:bg-orange-500 hover:text-white">
